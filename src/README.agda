...
{-
  Section 2.2. Computation types as cost algebras.
-}
{-
...
import Calf.Computation.Tensor.Base using
  ( _⊗_
  )
...
{-
  Section 5. Giralf: a graded, inferential, resource-aware layer over Calf.
-}
{-
    Sandboxection 5.1. Graded syntax.
...
{-
    Section 5.3. Inference algorithm.
    Examples 5.13, 5.14, 5.17, and 5.18. These examples are generated by the
    inference algorithm.
-}
import Examples.Giralf.Sandbox using
  ( snoc
  ; insert
  ; reverse
  ; isort
