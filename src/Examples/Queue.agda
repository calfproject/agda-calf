  ...
  where
    ...
    opaque
      ...
      dequeue'-point≡dequeueᴸ
        : (q : U Dequeue.BLQ)
        → PathP
            (λ i → U (ℕₚ ⋊ ◯[Abstractionᶜ≡A-abs] {BQ} {LQ} {α} abs i))
            (Dequeue.dequeue' .U q)
      ...
      dequeue'≡dequeueᴸ
        : PathP
            (λ i →
              ◯[Abstractionᶜ≡A-abs] {BQ} {LQ} {α} abs i
                ⊸ ℕₚ ⋊ ◯[Abstractionᶜ≡A-abs] {BQ} {LQ} {α} abs i)
            Dequeue.dequeue'
            dequeueᴸ
      dequeue'≡dequeueᴸ =
        ⊸-path
          (◯[Abstractionᶜ≡A-abs] {BQ} {LQ} {α} abs)
          (λ i → ℕₚ ⋊ ◯[Abstractionᶜ≡A-abs] {BQ} {LQ} {α} abs i)
          (ua→
            {e =
              ( ◯[Abstractionᶜ≃A-abs] {BQ} {LQ} {α} abs .fst .U
              , ◯[Abstractionᶜ≃A-abs] {BQ} {LQ} {α} abs .snd)}
            {B = λ i → U (ℕₚ ⋊ ◯[Abstractionᶜ≡A-abs] {BQ} {LQ} {α} abs i)}
            dequeue'-point≡dequeueᴸ)
