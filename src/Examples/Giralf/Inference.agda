...
snoc : ∀ {l1 q2 : ℕ} → (1 + q2 ≤ l1) → ⟨ Xₛ ⟩ → CList₂ (l1) (q2) (Xₛ) , (((l1 ∸ 1) ∸ q2) + 0) ⊢ CList₂ ((l1 ∸ 1) ∸ q2) (q2) (Xₛ)
snoc {X} {l1} {q2} cs x1 =
  payᴳ refl $
...
insert : ∀ {l1 q2 : ℕ} → (1 ≤ l1) × (1 + q2 ≤ l1) → ℕ → CList₂ (l1) (q2) ℕₛ , (((l1 ∸ 1) ∸ q2) + 0) ⊢ CList₂ ((l1 ∸ 1) ∸ q2) (q2) (ℕₛ)
insert {l1} {q2} cs x1 =
  payᴳ {p = (l1 ∸ 1) ∸ q2} {q' = 0} refl $ proj₁ᴳ {B = ◁[ 0 ] (CList₂ (l1 ∸ 1) (q2) (ℕₛ))} $
  powappᴳ {X = (1 ≤ l1) × (1 + q2 ≤ l1)}
    (arithmetic-9-left (fst cs) (snd cs) , arithmetic-9-right (fst cs) (snd cs)) $
  foldr₂ᴳ (λ p5 → (1 ≤ p5) × (1 + q2 ≤ p5) ⇀ ((◁[ (p5 ∸ 1) ∸ q2 ] (CList₂ ((p5 ∸ 1) ∸ q2) (q2) (ℕₛ))) ×ᶜ (◁[ 0 ] (CList₂ (p5 ∸ 1) (q2) (ℕₛ)))))
    (λ p5 →
    ...
    (λ p5 → λ xh3 →
      ...
      (
        ...
        if ((x1) ≤ᵇ (xh3)) then (
          ...
          substᵐᴳ (arithmetic-16 (snd cs5) (snd cs5)) $ subst2ᴳ (λ l q → CList₂ l q ℕₛ) (arithmetic-17 (snd cs5) (snd cs5)) (arithmetic-18 (snd cs5) (snd cs5)) $
          payᴳ {p = 0} {q' = 0} refl $ proj₂ᴳ {A = ◁[ ((q2 + p5) ∸ 1) ∸ q2 ] (CList₂ (((q2 + p5) ∸ 1) ∸ q2) (q2) (ℕₛ))} $
          ...
          substᵐᴳ (arithmetic-21 (snd cs5) (snd cs5)) $ subst2ᴳ (λ l q → CList₂ l q ℕₛ) (arithmetic-22 (snd cs5) (snd cs5)) (arithmetic-23 (snd cs5) (snd cs5)) $
          payᴳ {p = ((q2 + p5) ∸ 1) ∸ q2} {q' = 0} refl $ proj₁ᴳ {B = ◁[ 0 ] (CList₂ ((q2 + p5) ∸ 1) (q2) (ℕₛ))} $
          powappᴳ {X = (1 ≤ q2 + p5) × (1 + q2 ≤ q2 + p5)}
      ...
      (
        ...
        substᵐᴳ (arithmetic-26 (snd cs5) (snd cs5)) $ subst2ᴳ (λ l q → CList₂ l q ℕₛ) (arithmetic-27 (snd cs5) (snd cs5)) (arithmetic-28 (snd cs5) (snd cs5)) $
        payᴳ {p = 0} {q' = 0} refl $ proj₂ᴳ {A = ◁[ ((q2 + p5) ∸ 1) ∸ q2 ] (CList₂ (((q2 + p5) ∸ 1) ∸ q2) (q2) (ℕₛ))} $
        powappᴳ {X = (1 ≤ q2 + p5) × (1 + q2 ≤ q2 + p5)}
...
reverse : ∀ {l1 q2 : ℕ} → (1 ≤ q2) → CList₂ (l1) (q2) (Xₛ) , (0 + 0) ⊢ CList₂ (l1) (q2 ∸ 1) (Xₛ)
reverse {X} {l1} {q2} cs =
  payᴳ {p = 0} {q' = 0} refl $
...
isort : ∀ {l1 q2 : ℕ} → 1 ≤ q2 → CList₂ (l1) (q2) (ℕₛ) , (0 + 0) ⊢ CList₂ (l1) (q2 ∸ 1) (ℕₛ)
isort {l1} {q2} cs =
  payᴳ {p = 0} {q' = 0} refl $
  powappᴳ {X = 1 ≤ q2} (arithmetic-30 cs) $
  foldr₂ᴳ (λ p17 → (1 ≤ q2) ⇀ (◁[ 0 ] (CList₂ (p17) (q2 ∸ 1) (ℕₛ))))
    (λ p17 →
    ...
    (λ p17 → λ yh4 →
      ...
      getᴳ {q' = 0 + p17} (0) refl $
      substᵐᴳ (arithmetic-32 cs9) $ subst2ᴳ (λ p42 p41 → CList₂ (p42) (p41) (ℕₛ)) (arithmetic-33 cs9) (arithmetic-34 cs9) $
      payᴳ {p = ((q2 + p17) ∸ 1) ∸ (q2 ∸ 1)} {q' = 0 + 0} refl $ proj₁ᴳ {B = ◁[ 0 ] (CList₂ ((q2 + p17) ∸ 1) (q2 ∸ 1) (ℕₛ))} $
      powappᴳ {X = (1 ≤ q2 + p17) × (1 + (q2 ∸ 1) ≤ q2 + p17)} (arithmetic-36-left cs9 , arithmetic-35 cs9) $
      foldr₂ᴳ (λ p20 → ((1 ≤ p20) × (1 + (q2 ∸ 1) ≤ p20)) ⇀ ((◁[ (p20 ∸ 1) ∸ (q2 ∸ 1) ] (CList₂ ((p20 ∸ 1) ∸ (q2 ∸ 1)) (q2 ∸ 1) (ℕₛ))) ×ᶜ (◁[ 0 ] (CList₂ (p20 ∸ 1) (q2 ∸ 1) (ℕₛ)))))
        (λ p20 →
        ...
        (λ p20 → λ xh2 →
          ...
          pairᴳ (
            ...
            if ((yh4) ≤ᵇ (xh2)) then (
              ...
              substᵐᴳ (arithmetic-16 (snd cs10) (snd cs10)) $ subst2ᴳ (λ p48 p47 → CList₂ (p48) (p47) (ℕₛ)) (arithmetic-17 (snd cs10) (snd cs10)) (arithmetic-18 (snd cs10) (snd cs10)) $
              payᴳ {p = 0} {q' = 0} refl $ proj₂ᴳ {A = ◁[ (((q2 ∸ 1) + p20) ∸ 1) ∸ (q2 ∸ 1) ] (CList₂ ((((q2 ∸ 1) + p20) ∸ 1) ∸ (q2 ∸ 1)) (q2 ∸ 1) (ℕₛ))} $
              ...
              substᵐᴳ (arithmetic-21 (snd cs10) (snd cs10)) $ subst2ᴳ (λ p46 p45 → CList₂ (p46) (p45) (ℕₛ)) (arithmetic-22 (snd cs10) (snd cs10)) (arithmetic-23 (snd cs10) (snd cs10)) $
              payᴳ {p = (((q2 ∸ 1) + p20) ∸ 1) ∸ (q2 ∸ 1)} {q' = 0} refl $ proj₁ᴳ {B = ◁[ 0 ] (CList₂ (((q2 ∸ 1) + p20) ∸ 1) (q2 ∸ 1) (ℕₛ))} $
            ...
            substᵐᴳ (arithmetic-26 (snd cs10) (snd cs10)) $ subst2ᴳ (λ p44 p43 → CList₂ (p44) (p43) (ℕₛ)) (arithmetic-27 (snd cs10) (snd cs10)) (arithmetic-28 (snd cs10) (snd cs10)) $
            payᴳ {p = 0} {q' = 0} refl $ proj₂ᴳ {A = ◁[ (((q2 ∸ 1) + p20) ∸ 1) ∸ (q2 ∸ 1) ] (CList₂ ((((q2 ∸ 1) + p20) ∸ 1) ∸ (q2 ∸ 1)) (q2 ∸ 1) (ℕₛ))} $
